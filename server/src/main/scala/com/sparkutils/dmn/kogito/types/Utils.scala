...
class DecisionResultFullProxyEntry() extends ProxyEntry[util.List[kogito.DMNDecisionResult]] {

  private var key = ""
  private var res: Object = _
  private var entry = new util.Map.Entry[String, Object] {
    override def getKey: String = key
  ...
  override def get(i: Int, t: util.List[kogito.DMNDecisionResult]): util.Map.Entry[String, Object] = {
    val r = t.get(i)
...
class ProxySet[E](map: ProxyMap[E]) extends util.Set[util.Map.Entry[String, Object]] {
  // $COVERAGE-OFF$
  ...
  override def add(e: util.Map.Entry[String, Object]): Boolean = ???

  override def remove(o: Any): Boolean = ???

  override def containsAll(c: util.Collection[_]): Boolean = ???

  override def addAll(c: util.Collection[_ <: util.Map.Entry[String, Object]]): Boolean = ???
  // $COVERAGE-ON$
}
...
class ArrayEntry[K, V](keys: Array[K], values: Array[V], i: Int) extends util.Map.Entry[K, V] {
...
class ArraySet[E](backed: Array[E]) extends util.Set[E] {
  // $COVERAGE-OFF$
